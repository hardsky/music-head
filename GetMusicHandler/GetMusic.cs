...
namespace GetMusicHandler
{
    /// <summary>
    /// Summary description for GetMusic
    /// </summary>
    public class GetMusic : IHttpHandler, IReadOnlySessionState
    {
        public GetMusic()
        {
            //
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!String.IsNullOrEmpty(sId))
            {
                ...
                if (con != null)
                {
                    ...
                    {
                        con.Open();
                        MySqlCommand cmd = new MySqlCommand("select BandId, Visibility, Author, FileName from music where Deleted=0 and Id=?musicId", con);
                        cmd.Parameters.Add("?musicId", MySqlDbType.UInt64).Value = UInt64.Parse(sId);
