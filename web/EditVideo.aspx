<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EditVideo.aspx.cs" Inherits="EditVideo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="centerColumn" Runat="Server">
    ...
    <div class="dvFilter">
        ...
        <asp:PostBackTrigger ControlID="btnChangeFile" />        
            ...
            <uc1:ImageCover ID="ctrImgCover" runat="server" DefaultImgUrl="~/img/video_cover.gif" />
            <tr>
            ...
            <tr id="trDDGroup" runat="server">
                <td><asp:Label ID="lbLabelBand" runat="server" Text="Group: "></asp:Label></td>
                <td>
                    <div class="csFilterInput">
                        <div>
                            <div>            
