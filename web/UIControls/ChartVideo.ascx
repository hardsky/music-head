<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChartVideo.ascx.cs" Inherits="UIControls_ChartVideo" %>
<asp:Repeater ID="rpChartVideo" runat="server" 
    onitemdatabound="rpChartVideo_ItemDataBound">
<HeaderTemplate>
...
<ItemTemplate>
             <tr class="tblChartTable_Row">
                ...
                <td>
                    ...
                    NavigateUrl='<%#Jam.JamRouteUrl.PickUp("clip", this.LangEnum, new System.Collections.Generic.Dictionary<string, string>() { { "clip_id", Eval("Id").ToString() } })%>'></asp:HyperLink>
                </td>
                <td>
                ...
                <td>
                    <asp:HyperLink ID="hlToPage" NavigateUrl='<%#Jam.JamRouteUrl.PickUp("clip", this.LangEnum, new System.Collections.Generic.Dictionary<string, string>() { { "clip_id", Eval("Id").ToString() } })%>' 
             ...
             <tr class="tblChartTable_AltRow">
                ...
                <td>
                    <asp:HyperLink ID="hlComments" CssClass="csChartSub"
                     NavigateUrl='<%#Jam.JamRouteUrl.PickUp("clip", this.LangEnum, new System.Collections.Generic.Dictionary<string, string>() { { "clip_id", Eval("Id").ToString() } })%>' runat="server">комментарии</asp:HyperLink>                    
                </td>
             </tr>                                                                     
</ItemTemplate>
<SeparatorTemplate>
